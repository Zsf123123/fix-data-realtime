...
//    }
    ...
    public static List<Road> findRoutesByMinRectangle(LngAndLat min, LngAndLat max) throws SQLException {
        ...
        String sql = "select * from roads_v3 where " + min.getLng() + "> min_x and " + min.getLat() + "> min_y and " + max.getLng() + "< max_x and " + max.getLat() + "< max_y;";
    ...
    public static List<Road> finRouteByDistance(LngAndLat min, LngAndLat max) {
        ...
        String sql = "select * from \n" +
                ...
                "point2point_distance(max_x,max_y," + max.getLng() + "," + max.getLat() + ") as distance2 from roads_v3) temp\n" +
