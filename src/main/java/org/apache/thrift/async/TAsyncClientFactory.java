...
public interface TAsyncClientFactory<T extends TAsyncClient> {
    ...
    class TAsyncClientManager {
        ...
        private final ConcurrentLinkedQueue<org.apache.thrift.async.TAsyncMethodCall> pendingCalls = new ConcurrentLinkedQueue<org.apache.thrift.async.TAsyncMethodCall>();
        ...
        private class SelectThread extends Thread {
            ...
            private final TreeSet<org.apache.thrift.async.TAsyncMethodCall> timeoutWatchSet = new TreeSet<org.apache.thrift.async.TAsyncMethodCall>(new TAsyncMethodCallTimeoutComparator());
            ...
            private void timeoutMethods() {
                Iterator<org.apache.thrift.async.TAsyncMethodCall> iterator = timeoutWatchSet.iterator();
         ...
         */
        private static class TAsyncMethodCallTimeoutComparator implements Comparator<org.apache.thrift.async.TAsyncMethodCall>, Serializable {
