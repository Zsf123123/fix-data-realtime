...
public class FieldMetaData implements java.io.Serializable {
    ...
    private static Map<Class<? extends TBase>, Map<? extends TFieldIdEnum, org.apache.thrift.meta_data.FieldMetaData>> structMap;

    static {
        structMap = new HashMap<Class<? extends TBase>, Map<? extends TFieldIdEnum, org.apache.thrift.meta_data.FieldMetaData>>();
    }
    ...
    public static synchronized void addStructMetaDataMap(Class<? extends TBase> sClass, Map<? extends TFieldIdEnum, org.apache.thrift.meta_data.FieldMetaData> map) {
     ...
     */
    public static synchronized Map<? extends TFieldIdEnum, org.apache.thrift.meta_data.FieldMetaData> getStructMetaDataMap(Class<? extends TBase> sClass) {
