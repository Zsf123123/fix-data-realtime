...
public class TSaslServerTransport extends org.apache.thrift.transport.TSaslTransport {
    ...
    public static class Factory extends TTransportFactory {
         ...
         */
        private static Map<TTransport, WeakReference<org.apache.thrift.transport.TSaslServerTransport>> transportMap =
                Collections.synchronizedMap(new WeakHashMap<TTransport, WeakReference<org.apache.thrift.transport.TSaslServerTransport>>());
        ...
        public TTransport getTransport(TTransport base) {
            WeakReference<org.apache.thrift.transport.TSaslServerTransport> ret = transportMap.get(base);
            if (ret == null || ret.get() == null) {
                LOGGER.debug("transport map does not contain key", base);
                ret = new WeakReference<org.apache.thrift.transport.TSaslServerTransport>(new org.apache.thrift.transport.TSaslServerTransport(serverDefinitionMap, base));
                try {
                    ret.get().open();
